...
mixer.init()
mixer.music.load('TheGioiCuaAnh-BuiTuanNgoc-5276561.mp3')
...
# ==============="I"==================
t.pen(pencolor="red",fillcolor="pink", pensize=3, speed=8)
...
# ===============Love Part=================
# ================="L"=====================
t.pen(pencolor="white",fillcolor="pink", pensize=3, speed=2)
t.begin_fill()
